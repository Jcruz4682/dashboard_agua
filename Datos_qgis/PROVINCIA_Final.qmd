...
<qgis version="3.42.1-Münster">
  <identifier>BP_LIM_Provincial_INEI_2007</identifier>
  <parentidentifier></parentidentifier>
  <language>SPA</language>
  <type>dataset</type>
  <title>BP_LIM_Provincial_INEI_2007</title>
  <abstract>Superficie distrital registrada por el INEI año 2007

Información que formará parte de la cartografía base en los diferentes proyectos a desarrollar a nivel de país.</abstract>
  ...
  <links>
    <link mimeType="" description="" name="File Geodatabase Feature Class" url="file://\\WORKSTATION2-PC\D$\BD_OEFA_GEO\BD_NACIONAL.gdb" type="Local Area Network" format="" size=""/>
  </links>
  <dates/>
  <fees></fees>
  <constraints type="Acceso">Para uso interno del SIGMINAM</constraints>
  <rights>Para uso interno del SIGMINAM</rights>
  <encoding></encoding>
  <crs>
  ...
  <extent>
    <spatial maxx="1190990.76609999989159405" miny="7964768.91160000022500753" minz="0" maxy="9995732.8584000002592802" maxz="0" dimensions="2" minx="-203260.78969999999389984" crs="EPSG:32718"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
